  ...
  useEffect(() => {
    if (classData && isOpen) {
      setFormData({
        ...
        code: classData.code || '',
        teacher: classData.teacher || classData.classTeacherName || '',
        grade: classData.grade || '',
        subject: classData.subject || '',
        schedule: classData.schedule || '',
        room: classData.room || classData.roomNo || '',
        capacity: classData.capacity || 30,
        students: classData.students || classData.currentStudents || 0 // نیا فیلڈ شامل کیا
      });
      setErrors({});
    }
  }, [classData, isOpen]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Update class information</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
            >
              {loading ? (
                <>
