...
import { X, User, BookOpen, Mail, Phone, Hash, Calendar, Clock, Users } from 'lucide-react'; // Star ہٹا دیا
...
const EditTeacherModal = ({ isOpen, teacher, onClose, onSave, loading }) => {
  ...
  useEffect(() => {
    if (isOpen && teacher) {
      console.log('📝 Teacher data for editing:', teacher);
  ...
  const handleSubmit = () => {
    ...
    console.log('📤 Sending update data:', teacherData);
    onSave(teacherData);
  };
